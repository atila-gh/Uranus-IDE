...
class WorkWindowPython(QFrame):
    ...
    def setup_top_toolbar_buttons(self):
        ...
        self.toolbar.addWidget(self.chk_detach)  
    ...
    def apply_theme(self):
        ...
        bg = setting["colors"]["Back Ground Color WorkWindow"]
